...
# subprocess.call(['sh','./mfcc_cmvn.sh'])
# subprocess.call(['sh','./mono.sh'])
# subprocess.call(['sh','./tri1.sh'])
# subprocess.call(['sh','./tri2.sh'])
# subprocess.call(['sh','./tri3.sh'])
# subprocess.call(['sh','./sgmm2.sh'])
# subprocess.call(['sh','./mmi_sgmm2.sh'])
